...
class ExporterTest < Minitest::Test
  ...
  test "export specific paths" do
    I18n.load_path << Dir["./test/fixtures/yml/*.yml"]
    I18nJSON.call(config_file: "./test/config/specific.yml")
  ...
  test "export multiple files" do
    I18n.load_path << Dir["./test/fixtures/yml/*.yml"]
    I18nJSON.call(config_file: "./test/config/multiple_files.yml")
  ...
  test "export multiple files using :locale" do
    I18n.load_path << Dir["./test/fixtures/yml/*.yml"]
    I18nJSON.call(config_file: "./test/config/locale_placeholder.yml")
  ...
  test "export multiple files using :locale as dirname" do
    I18n.load_path << Dir["./test/fixtures/yml/*.yml"]
    I18nJSON.call(config_file: "./test/config/locale_placeholder_dir.yml")
